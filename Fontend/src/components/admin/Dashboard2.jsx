                    ...
                    <div className="dropdown">
                      ...
                      <div className="dropdown-menu dropdown-menu-right">
                        <a href="#" className="dropdown-item has-icon">
                          <i className="far fa-circle" /> Electronic
                        </a>
                        <a href="#" className="dropdown-item has-icon">
                          <i className="far fa-circle" /> T-shirt
                        </a>
                        <a href="#" className="dropdown-item has-icon">
                          <i className="far fa-circle" /> Hat
                        </a>
                  ...
                  <ul className="list-unstyled list-unstyled-border">
                    <li className="media">
                      ...
                      <div className="media-body">
                        ...
                        <div className="text-small text-muted">
                          Alfa Zulkarnain <div className="bullet" />{" "}
                    ...
                    <li className="media">
                      ...
                      <div className="media-body">
                        ...
                        <div className="text-small text-muted">
                          Serj Tankian <div className="bullet" /> 4 Min
                        </div>
                      </div>
                    </li>
                    <li className="media">
                      ...
                      <div className="media-body">
                        ...
                        <div className="text-small text-muted">
                          Ujang Maman <div className="bullet" /> 8 Min
                        </div>
                      </div>
                    </li>
                    <li className="media">
                      ...
                      <div className="media-body">
                        ...
                        <div className="text-small text-muted">
                          Farhan A Mujib <div className="bullet" /> 21 Min
                        </div>
                      </div>
                    </li>
                  </ul>
